...
declare namespace WechatMiniprogram.GlassEasel.Behavior {
  type DefinitionFilter = (
    ...
    childFilters: Array<((target: Component.TrivialDefinition) => void) | null>,
  ) => void;

  type ResolveBehaviorBuilder<B, TChainingFilter extends TypeUtils.ChainingFilterType> =
  ...
  > {
     ...
     */
    observer<
      P extends TypeUtils.ObserverDataPathStrings<TypeUtils.DataWithPropertyValues<TPrevData, TProperty>>,
      V = TypeUtils.GetFromObserverPathString<TypeUtils.DataWithPropertyValues<TPrevData, TProperty>, P>,
    >(
      paths: P,
      func: (this: Component.Instance<TData, TProperty, TMethod, any, TExtraThisFields>, newValue: V) => void,
      once?: boolean,
    ): ResolveBehaviorBuilder<this, TChainingFilter>;
    observer<
      P extends Array<TypeUtils.ObserverDataPathStrings<TypeUtils.DataWithPropertyValues<TPrevData, TProperty>>>,
      V = {
    ...
    pageLifetime(
      name: string,
      func: (this: Component.Instance<TData, TProperty, TMethod, any, TExtraThisFields>, ...args: any[]) => any,
      once?: boolean,
    ): ResolveBehaviorBuilder<this, TChainingFilter>;
    /**
     * Add a relation
    ...
    relation(
      ...
      rel: TypeUtils.RelationParams &
        ThisType<Component.Instance<TData, TProperty, TMethod, TComponentExport, TExtraThisFields>>,
    ): ResolveBehaviorBuilder<this, TChainingFilter>;
  }
  ...
  > {
    ...
    >(
      behavior:
        | Instance<UData, UProperty, UMethod, UChainingFilter, UComponentExport, UExtraThisFields>
    ...
    export<TNewComponentExport>(
      f: (this: Component.TrivialInstance, source: Component.TrivialInstance | null) => TNewComponentExport,
    ): ResolveBehaviorBuilder<
      Builder<
        TPrevData,
        TData,
    ...
    data<T extends TypeUtils.DataList>(
      gen: () => TypeUtils.NewFieldList<TypeUtils.DataWithPropertyValues<TData, TProperty>, T>,
    ): ResolveBehaviorBuilder<
      Builder<
        T,
        TData & T,
    ...
    staticData<T extends TypeUtils.DataList>(
      data: TypeUtils.NewFieldList<TypeUtils.DataWithPropertyValues<TData, TProperty>, T>,
    ): ResolveBehaviorBuilder<
      Builder<
        T,
        TData & T,
     ...
     */
    property<N extends string, T extends TypeUtils.PropertyType, V extends TypeUtils.PropertyTypeToValueType<T>>(
      name: N,
    ...
    methods<T extends TypeUtils.MethodList>(
      funcs: T & ThisType<Component.Instance<TData, TProperty, TMethod & T, TComponentExport, TExtraThisFields>>,
    ): ResolveBehaviorBuilder<
      Builder<
        TPrevData,
        TData,
     ...
     */
    init<TExport extends Record<string, TypeUtils.TaggedMethod<(...args: any[]) => any>> | void>(
      func: (
        this: Component.Instance<TData, TProperty, TMethod, TComponentExport, TExtraThisFields>,
        builderContext: TypeUtils.BuilderContext<
          TPrevData,
          TProperty,
          Component.Instance<TData, TProperty, TMethod, TComponentExport, TExtraThisFields>
        >,
      ) => TExport,
    ): ResolveBehaviorBuilder<
      Builder<
    ...
    >(
      def: Definition<TNewData, TNewProperty, TNewMethod, TNewComponentExport> &
        ThisType<
          Component.Instance<
            TData & TNewData,
     ...
     */
    register(): Instance<TData, TProperty, TMethod, TPendingChainingFilter, TComponentExport, TExtraThisFields>;
    /**
