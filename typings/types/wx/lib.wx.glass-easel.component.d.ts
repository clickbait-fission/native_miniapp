...
declare namespace WechatMiniprogram.GlassEasel.Component {
  ...
  type TrivialDefinition = Definition<IAnyObject, IAnyObject, IAnyObject, IAnyObject>;
  ...
  > = TMethod &
    TExtraThisFields & {
      ...
      data: TypeUtils.Merge<TypeUtils.DataWithPropertyValues<TData, TProperty>>;

      /** The component data and property values (same as `data` ) */
      properties: TypeUtils.Merge<TypeUtils.DataWithPropertyValues<TData, TProperty>>;
      ...
      spliceArrayDataOnPath<T extends Array<string | number>>(
        path: readonly [...T],
        index: TypeUtils.GetFromDataPath<TypeUtils.DataWithPropertyValues<TData, TProperty>, T> extends any[]
          ? number | undefined
          : never,
        del: TypeUtils.GetFromDataPath<TypeUtils.DataWithPropertyValues<TData, TProperty>, T> extends any[]
          ? number | undefined
          : never,
        inserts: TypeUtils.GetFromDataPath<TypeUtils.DataWithPropertyValues<TData, TProperty>, T> extends Array<infer I>
          ? I[]
          : never,
      ): void;
       ...
       */
      hasBehavior(behavior: Behavior.TrivialInstance | TraitBehavior.Instance<any, any>): boolean;
      /**
  ...
  interface TrivialInstance extends Instance<IAnyObject, IAnyObject, IAnyObject, IAnyObject, IAnyObject> {}
  ...
  > {
     ...
     */
    options(options: DefinitionOptions): Behavior.ResolveBehaviorBuilder<this, TChainingFilter>;
    ...
    >(
      behavior:
        | Behavior.Instance<UData, UProperty, UMethod, UChainingFilter, UComponentExport, UExtraThisFields>
    ...
    export<TNewComponentExport>(
      f: (this: TrivialInstance, source: TrivialInstance | null) => TNewComponentExport,
    ): Behavior.ResolveBehaviorBuilder<
      Builder<
        TPrevData,
        TData,
    ...
    >(
      def: PageDefinition<TNewData, TNewExtraFields> &
        ThisType<Instance<TData & TNewData, TProperty, TMethod & TNewExtraFields, undefined, TExtraThisFields>>,
    ): Behavior.ResolveBehaviorBuilder<
      Builder<
        TPrevData,
        TData & TNewData,
