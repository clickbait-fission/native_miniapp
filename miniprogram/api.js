...
const OssPutMeta = {
	...
	fromJSON(object) {
		return {
			url: isSet$7(object.url) ? globalThis.String(object.url) : "",
			form: isObject$2(object.form) ? globalThis.Object.entries(object.form).reduce((acc, [key, value]) => {
...
var BaseSessionManagement = class {
	...
	updateCachedUid(uid) {
		this.cacheUid.value = `${uid}`;
	}
	readCacheUid() {
		const r = zUid.safeParse(this.cacheUid.value);
		return r.success ? r.data : void 0;
	}
	async authedUid() {
		await this.authCheck;
		return this.readCacheUid();
	}
...
const SessionCheckResponse = {
	encode(message, writer = new BinaryWriter()) {
		...
		if (message.uid !== 0) writer.uint32(32).int64(message.uid);
		return writer;
	},
	decode(input, length) {
		const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
	...
	fromJSON(object) {
		return {
			...
			uid: isSet$6(object.uid) ? globalThis.Number(object.uid) : 0
		};
	},
	toJSON(message) {
		const obj = {};
...
var ApiAuth = class extends BaseApi {
	async userSessionCheck({ openId }) {
		const { needLogin, shareMark, uid } = await this.invokeProtoApi({
		...
		this.updateCachedShareMark(shareMark);
		this.updateCachedUid(uid);
		return { needLogin };
	}
	async userLogin({ code }) {
		const { openId, shareMark, uid } = await this.invokeProtoApi({
...
//#endregion
//#region src/compatible/add_remove_op.ts
function parseAddRemoveOp(op) {
	switch (op) {
		case "add": return 0;
		case "remove": return 1;
		default: throw new Error(`Unknown add/remove op: $op`);
	}
}
//#endregion
...
const zShareQuery = /* @__PURE__ */ object({
	media: /* @__PURE__ */ optional(/* @__PURE__ */ number()),
	user: /* @__PURE__ */ optional(/* @__PURE__ */ number()),
	shareTarget: /* @__PURE__ */ union([/* @__PURE__ */ literal([
		"message",
		"timeline",
		"favorite"
	]), /* @__PURE__ */ string()]),
	timestamp: /* @__PURE__ */ number(),
	shareId: /* @__PURE__ */ string(),
	sourceUser: /* @__PURE__ */ string(),
	sourceMark: /* @__PURE__ */ string(),
	enterOpts: /* @__PURE__ */ object({
		opts: /* @__PURE__ */ object({
			scene: /* @__PURE__ */ optional(/* @__PURE__ */ number()),
			chatType: /* @__PURE__ */ optional(/* @__PURE__ */ number()),
			groupEncryptedData: /* @__PURE__ */ optional(/* @__PURE__ */ string()),
			groupIv: /* @__PURE__ */ optional(/* @__PURE__ */ string())
		}),
		shareId: /* @__PURE__ */ optional(/* @__PURE__ */ string())
	})
});
